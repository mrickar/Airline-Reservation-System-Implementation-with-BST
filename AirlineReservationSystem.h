...
private: // YOU MAY ADD YOUR OWN UTILITY MEMBER FUNCTIONS HERE.
    void searchFlightHelper(const std::string &departureCity, const std::string &arrivalCity, std::vector<Flight *> &vc, BSTNode<Flight > *cur);
    Flight *findFlightWithCode(BSTNode<Flight> *curNode,const std::string &flightCode);
